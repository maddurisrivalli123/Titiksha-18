...
This application is used for sharing titiksha's upcoming events details and results of the events completed
...
### Technical Overview
This app can retrieve data from Firefbase in Realtime and display it in the app using Recycler view. 
